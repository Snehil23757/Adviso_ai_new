        ...
        <div className="space-y-4">
          <div className="grid grid-cols-2 gap-3">
            <div className="bg-black/30 p-3 rounded-xl border border-white/5 text-center">
              ...
              <span className="block text-lg font-bold text-white mt-1">$22,000</span>
    ...
    Founders: {
      ...
      visual: (
        <div className="space-y-4">
          ...
          <div className="bg-white/5 p-3 rounded-lg border border-white/5 text-xs text-brand-text-secondary leading-relaxed">
        ...
        <div className="space-y-4">
          <div className="bg-black/40 p-4 rounded-xl border border-white/5 space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2 text-[10px] font-mono">
              <div className="p-2 bg-white/5 rounded border border-white/5 text-white flex items-center gap-1.5">
  ...
  return (
    <section id="use-cases" className="relative py-24 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 relative z-10 w-full space-y-12">
        ...
        <div className="flex flex-wrap items-center justify-center gap-2 border-b border-white/5 pb-2">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center bg-brand-surface/10 rounded-2xl border border-white/5 p-6 lg:p-10">
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            ...
            <div className="pt-4">
              <button 
                ...
                className="bg-brand-primary hover:bg-brand-primary/95 text-xs font-bold text-white px-5 py-3 rounded-lg flex items-center gap-1.5 transition cursor-pointer"
              >
          ...
          <div className="lg:col-span-5 w-full">
            <div className="rounded-xl border border-white/10 bg-black/40 p-5 relative overflow-hidden">
