    ...
    <section id="dashboard-showcase" className="relative py-24 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 w-full space-y-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-5 bg-brand-surface/40 backdrop-blur-md rounded-2xl border border-white/5 p-6 flex flex-col justify-between">
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center text-xs">
                  <span className="font-semibold text-white">Pricing Optimization Index</span>
                ...
                <input
                  ...
                  className="w-full accent-brand-primary h-1 rounded-full bg-white/10 outline-none cursor-pointer"
                />
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center text-xs">
                  <span className="font-semibold text-white">Marketing Acquisition budget</span>
                ...
                <input
                  ...
                  className="w-full accent-emerald-400 h-1 rounded-full bg-white/10 outline-none cursor-pointer"
                />
                <div className="flex justify-between text-[10px] font-mono text-brand-text-secondary uppercase">
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center text-xs">
                  <span className="font-semibold text-white">Operational Efficiency Scale</span>
                ...
                <input
                  ...
                  className="w-full accent-indigo-400 h-1 rounded-full bg-white/10 outline-none cursor-pointer"
                />
                <div className="flex justify-between text-[10px] font-mono text-brand-text-secondary uppercase">
          ...
          <div className="lg:col-span-7 bg-brand-surface/40 backdrop-blur-md rounded-2xl border border-white/5 p-6 flex flex-col justify-between">
            <div className="space-y-4">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 border-b border-white/5 pb-3">
                <div>
                  ...
                  <h4 className="text-sm font-bold text-white mt-1">Four-Quarter Cumulative Impact Projection</h4>
                </div>
            ...
            <div className="grid grid-cols-3 gap-4 pt-4 border-t border-white/5 text-center">
              ...
              <div>
                ...
                <span className="block text-[10px] font-bold text-white uppercase mt-1 truncate">
