      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 w-full space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 text-left">
          {securityPillars.map((p, pIdx) => (
            <div key={pIdx} className="bg-brand-surface/30 rounded-2xl border border-white/5 p-6 hover:border-brand-primary/20 hover:bg-brand-surface/40 transition-all duration-300 space-y-4">
