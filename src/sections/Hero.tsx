...
import { ArrowRight, CheckCircle2, Cpu, TrendingUp } from "lucide-react";
              ...
              <div className="grid grid-cols-2 gap-y-6 gap-x-4">
                {[
                  ...
                  <div key={item.title} className="flex items-start gap-3 group">
                    ...
                    <div>
                      <h3 className="text-sm font-bold text-brand-text-primary leading-none mb-1 group-hover:text-brand-primary transition-colors">
                        {item.title}
                      </h3>
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-brand-surface-secondary/50 p-4 rounded-2xl border border-brand-border shadow-sm">
                  ...
                  <div className="flex items-baseline gap-2 mt-2">
                    <span className="text-3xl font-black text-brand-text-primary">
                      18.4 <span className="text-base text-brand-text-secondary font-medium">mo</span>
                    </span>
                    <span className="text-[11px] font-mono text-emerald-500 font-bold leading-none bg-emerald-500/10 px-1.5 py-0.5 rounded">
                      +35%
                    </span>
                  </div>
                </div>
                <div className="bg-brand-surface-secondary/50 p-4 rounded-2xl border border-brand-border shadow-sm">
                  ...
                  <div className="flex items-baseline gap-2 mt-2">
                    <span className="text-3xl font-black rounded text-transparent bg-clip-text bg-gradient-to-br from-brand-primary to-blue-400">
                      94.8%
                    </span>
                    <span className="text-[11px] font-mono text-indigo-500 font-bold leading-none bg-indigo-500/10 px-1.5 py-0.5 rounded">
                      ALPHA
                    </span>
                  </div>
                </div>
              ...
              <div className="rounded-2xl border border-brand-primary/30 bg-brand-primary/5 p-5 space-y-3 hover:bg-brand-primary/10 transition-colors cursor-default shadow-sm relative overflow-hidden">
                ...
                <p className="text-sm text-brand-text-secondary leading-relaxed">
                  Reallocate 12% unused cloud-resource reserve credits from staging.{" "}
                  <strong className="text-brand-text-primary font-medium">
                    Increases runway by 2.4 months.
                  </strong>
                </p>
              </div>
